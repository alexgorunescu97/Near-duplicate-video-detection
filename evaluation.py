...
def evaluate_cc_web(val_dataset, val_features, model, fusion='early', results_path=None, evaluation_features=None, positive_labels='ESLMV', val_ind_map=None, full_evaluation=True):
    ...
    mAP_dml, pr_curve_dml = evaluate(cc_dataset['ground_truth'], cc_dataset['index'], cc_dataset['queries'], similarities, results_path,
    ...
    if full_evaluation:
        ...
        mAP_base, pr_curve_base = evaluate(cc_dataset['ground_truth'], cc_dataset['index'], cc_dataset['queries'], baseline_similarities, results_path,
